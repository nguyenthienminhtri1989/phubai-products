...
async function main() {
  ...
  users.forEach((u) => {
    console.log(
      `  [${u.id}] ${u.fullName} (@${u.username}) — role: ${u.userRole}, active: ${u.isActive}`,
    );
  });
  ...
  const pages = [
    ...
    },
    {
      ...
      pageName: "Phiên bản & Chi tiết ĐM",
      pageGroup: "ĐỊNH MỨC",
    ...
    },
    {
      ...
      pageName: "So sánh thực tế vs ĐM",
      pageGroup: "ĐỊNH MỨC",
    ...
    },
    {
      ...
      pageName: "Theo dõi đơn hàng",
      pageGroup: "KINH DOANH",
      path: "/sales-orders",
      sortOrder: 406,
    },
    {
      pageKey: "kdsx.daily-input",
      pageName: "Nhập SL ngày (KD)",
      pageGroup: "KINH DOANH",
      path: "/kd-daily-input",
      sortOrder: 407,
    },
  ...
  console.log(
    `✅ page_registry: ${finalCount} trang (đã upsert ${created} trang)`,
  );
}
