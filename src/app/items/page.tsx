...
export default function ItemsManagementPage() {
  ...
  const handleSave = async (values: any) => {
    try {
      ...
      message.success(
        editingItem ? "Cập nhật thành công!" : "Tạo mới thành công!",
      );
            ...
            <div style={{ position: "relative", display: "inline-block" }}>
              ...
              <AutoComplete
                ...
                filterOption={(inputValue, option) =>
                  option?.value
                    ?.toLowerCase()
                    .startsWith(inputValue.toLowerCase()) ?? false
                }
                allowClear
        ...
        <Form form={form} layout="vertical" onFinish={handleSave}>
          ...
          <Form.Item name="yarnType" label="Loại sợi">
            <Select
              defaultValue="SINGLE"
              options={[
                { label: "Sợi 100% cotton", value: "SINGLE" },
                { label: "Sợi pha", value: "BLENDED" },
              ]}
            />
          </Form.Item>
